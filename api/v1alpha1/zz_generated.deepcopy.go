...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestRefSpec) DeepCopyInto(out *TestRefSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestRefSpec.
func (in *TestRefSpec) DeepCopy() *TestRefSpec {
	if in == nil {
		return nil
	}
	out := new(TestRefSpec)
