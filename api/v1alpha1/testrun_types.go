...
type TestRunSpec struct {
	...
	TestRef TestRefSpec `json:"testRef,omitempty"`
}
...
// TestRunPhase is a string representation of the phase of a test run
type TestRunPhase string

const (
	TestRunPhasePending   TestRunPhase = "Pending"
	TestRunPhaseStarting  TestRunPhase = "StartingJob"
